            ...
            <div className="container">
                <div className="card mb-3">
                    ...
                    <div className="card-body">
                        ...
                        ¡Felicidades, pasaste la verificación de contraseña y correo electrónico!</h5>
                        <button type="submit" className="btn btn-primary" onClick={signOut}>Cerrar sesión</button>
                    </div>
                </div>
